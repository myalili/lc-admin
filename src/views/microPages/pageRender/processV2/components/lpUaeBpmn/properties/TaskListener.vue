<template>
  <el-collapse-item name="taskListener">
    <div slot="title" class="panel-tab__title"><i class="header-icon el-icon-message-solid"></i> 任务监听器</div>
    <div>
...
<script>
import ExecutionListener from '@uae/uae-bpmn-editor/definitions/processElements/common/taskListener.js';
...
export default {
  ...
  computed: {
    listeners: {
      get() {
        return this.node.taskListeners;
      },
      set(val) {
        this.node.taskListeners = val;
      }
    }
  },
  filters: {

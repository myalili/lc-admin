<template>
  <el-container class="lp-ru-inst-involved-me" v-loading="listLoading">
    <el-header class="aops-search-box" style="height:auto;position:relative;padding-top:0">
      <el-form :inline="true">
    ...
    <el-main style="padding: 0 20px;max-height:580px">
      <AopsTable :data="list" style="width: 100%">
...
<script>
const moduleName = 'afoeAdminLpRuInstInvolvedMe';

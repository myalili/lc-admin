          ...
          <el-timeline class="timeline-style">
            <el-timeline-item v-for="(item, index) in timeline.children" :key="index" :type="item.status == 1 ? 'primary' : 'danger'" size="normal">
              <div class="timeline-info">
                ...
                <span class="user-name">{{ (item.createUser && item.createUser.substring(0, 1)) || "" }}</span>
...
import loggerTable from "./components/userLoggerTable";
// import moment from 'moment'
// const getID = () =>
//   Math.random()
//     .toString(16)
//     .substring(2);
import loggerDetailDialog from './components/loggerDetailDialog.vue'
// window.activator.registComponent({
//   loggerDetailDialog
// })
let getObj = () => {
  return {

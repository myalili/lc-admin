<template>
  <!-- 抄送给我的流程实例 -->
  <el-container direction="vertical" class="record-attention" v-loading="listLoading">
    ...
    <el-main style="padding: 0 20px;max-height:580px">
      <AopsTable :data="list" tooltip-effect="dark" style="width: 100%">
        ...
        <el-table-column min-width="70" prop="processDefinitionName" label="流程定义名称" show-overflow-tooltip />
        ...
        <el-table-column min-width="60" prop="startUserId" label="发起人" show-overflow-tooltip />
...
<script>
const moduleName = 'afoeAdminLpHiInstInvolvedMe';

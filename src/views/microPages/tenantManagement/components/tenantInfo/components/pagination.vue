...
<div class="custom-pagination-wrap" v-show="total!==0">
    ...
    <div class="custom-pager-right-ctn">
        <el-select v-model="pageSizeC" placeholder="请选择" class="pagesize-select" popper-class="pagesize-popver" @change="sizeChange">
            <el-option
        ...
        <div class="custom-pager-ctn">
            <el-button :disabled="currentPageC===1" class="custom-prev-btn" icon="el-icon-arrow-left" @click="prevPage"></el-button>
            <el-select v-model="currentPageC" placeholder="请选择" class="pagesize-select" popper-class="pagesize-popver" @change="pageChange">
                <el-option
            ...
            <el-button :disabled="currentPageC===pagerCount" class="custom-next-btn" icon="el-icon-arrow-right" @click="nextPage"></el-button>
        </div>
    </div>
</div>
    ...
    watch:{
        pageSizeC:{
            handler(val,oldVal){
                ...
                this.pagerCount<this.currentPageC&&(this.currentPageC = this.pagerCount);
...
immediate:true
        ...
        total:{
            handler(val,oldVal){
                ...
                this.currentPageC = this.pagerCount>0?1:0;
                for(let i=0;i<this.pagerCount;i++){
                    this.pagerOption.push(i+1);
                }

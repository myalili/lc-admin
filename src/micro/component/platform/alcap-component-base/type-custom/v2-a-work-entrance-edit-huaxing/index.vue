  ...
  <div class="v2-a-work-files-edit">
    <div class="string_input mb-4">
      <span class="flex items-center justify-between">
        ...
        <el-input style="width: 180px" v-model="obj.model[item.name].entitle" size="mini" placeholder="请输入标题"></el-input>
      </span>
    </div>
    <div class="string_input mb-4">
      <span class="flex items-center justify-between">
      ...
      <div class="">
        ...
        >
          ...
          <div class="content">
            ...
            <div class="proto">
              <div class="pcr">背景</div>
              <el-color-picker v-model="itemi.bgColor"></el-color-picker>
            </div>
            <div class="proto">
              <div class="pcr">自定义图标</div>
              <codeless-dialog-icon :value.sync="itemi.customIcon" :operationEnable = "true" />
            </div>
          </div>
        </div>
      </div>
...
export default {
  _options: pck.docs,
  name: "v2AWorkEntranceEditHuaxing",

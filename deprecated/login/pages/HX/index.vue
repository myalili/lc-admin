    ...
    <div class="login-svg-ctn">
      <svg id="svgMove" width="100" height="100" viewBox="1 6.2 169 49">
        ...
        <path
          ...
          stroke-linecap="round"
        />
        <circle id="circle" cx="2.8" cy="34" r="0.36" fill="#fff" />
      </svg>
    </div>
...
export default {
  ...
  computed: {
    logoSrc() {
      return require("./img/logohuahorizon.png");
    },
    adminLogo() {
...
.login-wrapper {
  // position: fixed;
  // background: linear-gradient(to right, rgba(255,87,87,1) 0%, rgba(255,0,0,1) 100%);
